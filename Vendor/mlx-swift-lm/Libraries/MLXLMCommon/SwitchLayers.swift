...
/// `DARKBLOOM_DIRECT_GATHER_LOADS` (default OFF pending ranked validation
/// of the store-side half; set "1" to enable the direct loads, "0"/unset to
...
public let lagunaDirectGatherLoadsEnabled =
    ProcessInfo.processInfo.environment["DARKBLOOM_DIRECT_GATHER_LOADS"] == "1"
