...
// Regular dense GEMM-only scheduling experiment. Other NAX compositions keep
// calling gemm_loop above and therefore retain its original no-unroll and
// volatile-compiler-barrier schedule.
template <
    typename T,
    short SM,
    short SN,
