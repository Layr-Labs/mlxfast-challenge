...
// the upstream algorithm. Same JIT plumbing as QHOIST above: the env var is
// read by get_steel_attention_nax_kernel in jit_kernels.cpp and prepended to
// the mlx-generated string, which is the runtime-effective twin.
//
