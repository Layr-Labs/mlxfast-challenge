...
#define instantiate_quantized_all_rhs(type, mode, group_size, bits) \
  ...
  instantiate_gather_qmm_rhs(fp_gather_qmm_rhs_lhs_nax, gather_qmm_rhs_lhs_nax_nt, type, 64, 64, 64, 2, 2, true, mode, group_size, bits) \
  instantiate_gather_qmm_rhs(fp_gather_qmm_rhs_lhs_nax, gather_qmm_rhs_lhs_nax_nn, type, 64, 64, 64, 2, 2, false, mode, group_size, bits)
