...
//
// DEFAULT ON as of this tree, read as `!= "0"`. The arm extends 8 fragments'
// live range across the whole loop (+28 registers/thread); this submission IS
// the paired measurement the original note asked for -- the ranked run is the
// only instrument that can price the occupancy trade.
//
