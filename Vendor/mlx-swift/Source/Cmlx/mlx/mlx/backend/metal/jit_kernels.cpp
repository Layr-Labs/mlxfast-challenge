...
//
// DEFAULT ON for the standalone ranked arm; set
// `DARKBLOOM_ATTN_QHOIST=0` to recover the stock in-loop loads. The hoist
// extends eight fragments' live range across the loop (+28 registers/thread),
// so the paired M5 result decides whether the lower loader pressure outweighs
// the register-residency cost.
//
