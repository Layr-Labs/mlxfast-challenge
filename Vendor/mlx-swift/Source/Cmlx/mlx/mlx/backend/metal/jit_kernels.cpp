...
// DARKBLOOM_EXPERT_EPILOGUE_BARRIER_ELIDE: injected exactly like the levers
// above (once per process, expert kernels only, never a specialization
// key). Default ON; "0" preprocesses back to the stock barrier source.
