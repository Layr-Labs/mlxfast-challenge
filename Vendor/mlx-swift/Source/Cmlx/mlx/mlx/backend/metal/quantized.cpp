...
// DARKBLOOM_DIRECT_GATHER_LOADS (default OFF pending ranked validation of
// the store-side half; set "1" to enable, "0"/unset reverts to the stock
...
bool darkbloom_direct_gather_loads_enabled() {
  static const bool v =
      env::get_var("DARKBLOOM_DIRECT_GATHER_LOADS", "") == "1";
  return v;
}
