...
// DARKBLOOM_ATTN_QHOIST default. DEFAULT ON: the kernel below uses the shipped
// loop-invariant Q-fragment hoist (an unmeasured mechanism). The host may
// still prepend `#define DARKBLOOM_ATTN_QHOIST 1` ahead of this string (see
