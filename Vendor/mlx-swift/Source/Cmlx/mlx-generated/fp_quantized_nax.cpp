...
// again. This variant assigns the experts across tg_expert_groups
// threadgroups. Each expert's contiguous interval is found by two lower
// bounds, chunked only when it genuinely exceeds BM, and therefore stages
