...
private let lagunaLmHeadExactBetaEnabled =
    ProcessInfo.processInfo.environment["DARKBLOOM_LMHEAD_EXACT_BETA"] == "1"
...
private let lagunaLmHeadLaneUniformEnabled =
    ProcessInfo.processInfo.environment["DARKBLOOM_LMHEAD_LANE_UNIFORM"] == "1"
...
private let lagunaLmHeadRowSkipEnabled =
    ProcessInfo.processInfo.environment["DARKBLOOM_LMHEAD_ROW_SKIP"] == "1"
