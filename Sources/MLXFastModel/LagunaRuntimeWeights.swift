    ...
    public init(loader: LagunaWeightLoader, config: LagunaConfig) {
        ...
        if config.numHiddenLayers >= 16 {
            ...
            if policy.isLowMemory {
                ...
                // 50: the P4-receipted setting. A 100 probe measured
                // neutral-to-adverse on submission af6f27da (dec 5117.0,
                // pre 191.44 against this content's class); the neighborhood
                // is priced, 50 stands.
