...
/// schedulable groups. Keep 512 as a same-binary rollback.
...
/// Enqueue layer 0's already-constructed QKV and gate projections before the
/// rest of that layer's graph is built. This is scheduling-only and decode-only.
