...
// Official replay marker: the preceding declaration and every executable
// path remain unchanged; this comment makes a gate-clean timing remeasurement
// archive-distinct after the CLI correctly deduplicated the original payload.
