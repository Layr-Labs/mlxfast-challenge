...
/// Telemetry re-roll nonce r5: unchanged candidate, official retry per the
/// established unchanged-resubmission practice (cf. e8e195b5's promoted nonce).
/// Attempts 212e97cf and 6a709649 both died on candidate-side telemetry
/// (n=4, n=4/plausibility-window, n=4/n=4); every RESULT line across both
/// runs computed to a promoting score (~1.85-1.86 vs frontier 1.84352).
