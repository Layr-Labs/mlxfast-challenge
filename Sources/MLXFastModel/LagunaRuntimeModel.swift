...
/// `DARKBLOOM_ZEROCOPY_LHS_LAYERS=<n>` (default 16): apply zero-copy LHS
...
/// an invalid or absent value selects the conservative default.
private let lagunaZeroCopySortedLHSSparseLayerCount: Int = {
    ...
    return max(0, raw.flatMap(Int.init) ?? 16)
}()
