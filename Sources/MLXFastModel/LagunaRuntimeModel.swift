...
/// (`DARKBLOOM_NATIVE_AFFINE_NVFP4_FROM`, default 24 — the next bounded tail
/// chunk after layers 32...39 passed every ranked correctness gate), using the
/// same group-16 4-bit NVFP4 the routed experts already ship. Set
