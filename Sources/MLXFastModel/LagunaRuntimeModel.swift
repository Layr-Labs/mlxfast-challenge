...
/// fused embedding+atlas kernel above. Set `DARKBLOOM_ROPE_ATLAS_VIEWS=0`
/// to restore stock (was default OFF, now ON for v11 chunk).
let lagunaRoPEAtlasViewsEnabled =
    ProcessInfo.processInfo.environment["DARKBLOOM_ROPE_ATLAS_VIEWS"] != "0"
