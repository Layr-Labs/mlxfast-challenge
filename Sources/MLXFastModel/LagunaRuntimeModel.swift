...
/// Telemetry re-roll nonce r8: unchanged candidate, official retry per the
/// established unchanged-resubmission practice (cf. e8e195b5's promoted nonce).
/// Attempts 212e97cf, 6a709649, 5367d9f7, 6a774a99, and 64fe3ae1 all died
/// on candidate-side telemetry (10/10 timed attempts: nine n=4, one n=5
/// killed by the plausibility-window artifact); every RESULT line across
/// all five runs computed to a promoting score (~1.85-1.86 vs frontier
/// 1.84352). The candidate's ~1.0s compute window sits below the sampler's
/// reliable-n=5 boundary; operator escalation with run links is in flight.
