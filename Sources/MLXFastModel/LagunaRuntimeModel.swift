...
/// (`DARKBLOOM_NATIVE_AFFINE_NVFP4_FROM`, default 38 — the telemetry-targeted
/// two-layer tail window; the full eight-layer speed bank remains available
/// with an explicit value of 32, and per-layer amplification is ~15x below
/// the early layers), using the same
...
private let lagunaNativeAffineNVFP4From: Int? = {
    ...
    let raw = ProcessInfo.processInfo.environment["DARKBLOOM_NATIVE_AFFINE_NVFP4_FROM"] ?? "38"
