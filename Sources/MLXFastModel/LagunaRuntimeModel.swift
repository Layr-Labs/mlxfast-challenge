...
/// A/B selector for transferring the common group-16 NVFP4 qdot helper to
/// static one-token QKV R1. The original tail helper remains the default:
/// the common helper is exact but regressed official M5 decode timing.
private let lagunaDecodeNVFP4QKVCommonQDotEnabled =
    ProcessInfo.processInfo.environment[
        "DARKBLOOM_DECODE_NVFP4_QKV_COMMON_QDOT"] == "1"
