...
/// as today, then increment a persistent device counter behind a
...
/// Persistent election counter (slot 0 used; zeroed once here, self-reset
/// by the elected threadgroup every step).
nonisolated(unsafe) private let lagunaRouterFoldCounter: MLXArray = {
