...
/// Scheduling A/B for the merged routed/shared gate/up kernel. The measured R2
/// schedule remains the process default. Only the literal selector value `4`
/// enables the R4 control. R4 preserves each row's arithmetic; its only risk
/// is performance from higher register pressure and occupancy tradeoffs.
