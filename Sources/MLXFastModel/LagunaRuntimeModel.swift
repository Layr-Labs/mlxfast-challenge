...
/// `(ordinal, expert index)` total order. Set
/// `DARKBLOOM_ROUTED_GATEUP_SORTED_TOP8=0` for the rescan control.
...
private func lagunaRouterTop8SortedPrelude(publishingRoute: Bool) -> String {
