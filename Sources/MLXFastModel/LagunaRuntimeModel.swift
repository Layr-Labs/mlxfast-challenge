...
/// which stays authoritative and resident. Ranked chunks proved 16, 24, and
/// then 32 layers; this final bounded chunk widens the same layout to all 40
/// layers, completing the rollout exactly the way
/// `DARKBLOOM_NATIVE_AFFINE_QKV_LAYERS` was finished.
///
