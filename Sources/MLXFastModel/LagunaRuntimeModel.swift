...
/// Telemetry re-roll nonce r6: unchanged candidate, official retry per the
/// established unchanged-resubmission practice (cf. e8e195b5's promoted nonce).
/// Attempts 212e97cf, 6a709649, and 5367d9f7 all died on candidate-side
/// telemetry (6/6 timed attempts: five n=4, one n=5 killed by the
/// plausibility-window artifact); every RESULT line across all three runs
/// computed to a promoting score (~1.85-1.86 vs frontier 1.84352). The
