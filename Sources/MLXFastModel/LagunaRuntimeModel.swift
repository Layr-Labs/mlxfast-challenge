...
///     ladder1  (40 fires)  1.0178   <- promoted default (every-layer fire;
///                                 M5 Pro measured ~3.4% decode faster and
///                                 markedly lower variance vs the six-fire
///                                 default; bit-exact, schedule-only,
///                                 correctness-gate-verified)
///     at:1,7,15,23,31,39   1.0170   <- previous shipped default (six fires)
///
