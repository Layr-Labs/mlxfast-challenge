...
/// (`DARKBLOOM_NATIVE_AFFINE_NVFP4_FROM`, default 24 — the tail window whose
/// per-layer amplification is well below the early layers; widened 32 -> 24 as
/// one band-safe chunk, and `=32` restores the previous window exactly),
/// using the same
