...
/// Telemetry re-roll nonce r7: unchanged candidate, official retry per the
/// established unchanged-resubmission practice (cf. e8e195b5's promoted nonce).
/// Attempts 212e97cf, 6a709649, 5367d9f7, and 6a774a99 all died on
/// candidate-side telemetry (8/8 timed attempts: seven n=4, one n=5 killed
/// by the plausibility-window artifact); every RESULT line across all four
/// runs computed to a promoting score (~1.85-1.86 vs frontier 1.84352). The
/// candidate's ~1.0s compute window sits at the sampler's n=4/5 boundary.
