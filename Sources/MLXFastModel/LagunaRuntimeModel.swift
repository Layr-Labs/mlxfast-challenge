...
/// Remove the dead `+0.0f` seed from the INT8 accumulation loops by peeling
/// their first product. Setting `DARKBLOOM_SEED_ELIDE_RESIDUAL=0` restores
/// the promoted source strings for a same-binary fallback.
