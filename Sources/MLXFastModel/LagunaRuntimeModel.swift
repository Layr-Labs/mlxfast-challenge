...
// v4 r2: KBATCH4 port onto b38f18c + LAYER_PLAN + swizzle + qblock-descend
// riders. Unchanged-candidate re-roll per established practice: prior attempt
// 3f7044b6 measured candidate decode 0.006978 s/tok (campaign fastest) but
// drew baseline decode 0.013852 and fell 0.18% short of the frontier —
// inside the documented same-session baseline-draw variance.
//
