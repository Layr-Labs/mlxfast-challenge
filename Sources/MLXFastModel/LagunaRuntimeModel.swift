...
// Match LLMModel.prepare and bound rotating-cache prefill work above 512 rows.
private let lagunaPrefillChunkSize = 512

// The singleton batch stride marks Laguna's verified steady sliding mask.
