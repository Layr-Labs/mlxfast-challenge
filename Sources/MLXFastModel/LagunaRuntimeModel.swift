...
/// `DARKBLOOM_SHARED_GATEUP_K1_STAGE` (default ON; "0" restores the plain
/// k-loop): the routed gate/up depth-1 rotating scalar staging applied to
...
let lagunaSharedGateUpK1StageEnabled =
    ProcessInfo.processInfo.environment["DARKBLOOM_SHARED_GATEUP_K1_STAGE"] != "0"
...
/// `DARKBLOOM_ROUTED_GATEUP_K1_STAGE` (default ON; set "0" for the plain
/// k-loop): depth-1 rotating scalar staging of the weight stream. The plain
...
let lagunaRoutedGateUpK1StageEnabled =
    ProcessInfo.processInfo.environment["DARKBLOOM_ROUTED_GATEUP_K1_STAGE"] != "0"
...
/// `DARKBLOOM_ROUTED_DOWN_ROW_STAGE` (default ON; "0" restores the plain
/// row loop): row-granular rotating scalar staging for the routed down
...
let lagunaRoutedDownRowStageEnabled =
    ProcessInfo.processInfo.environment["DARKBLOOM_ROUTED_DOWN_ROW_STAGE"] != "0"
