...
// PC2 persistence replay; executable semantics are unchanged.
...
// Exact active64 tournament; full-sort fallback remains available.
...
/// Exact two-stage prefill router tournament; set the documented flag to ablate.
