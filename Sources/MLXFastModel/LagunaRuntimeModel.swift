...
// Official paired-M5 replay nonce 20260807T0034Z; executable source unchanged.
...
/// `DARKBLOOM_QMV_WIDE_CODES` (default ON; set "0" to ablate): the shared
...
let lagunaSharedQMVWideCodesEnabled =
    ProcessInfo.processInfo.environment["DARKBLOOM_QMV_WIDE_CODES"] != "0"
