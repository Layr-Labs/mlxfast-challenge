...
private func lagunaFusedSortedRoutedGateUp(
    ...
    if doSort && directSortedLHS {
        ...
        directLHSIndices = plan.lhsIndices
    ...
    let gateUp = MLX.gatherQuantizedMM(
        ...
        scales: fusedScales,
        biases: nil,
        // Keep MLX's logical output broadcast at 4,096 routed rows. Omitting
        // this map cross-broadcasts the compact 512-row LHS with the 4,096
        // RHS routes before the backend can consume the packed carrier.
        lhsIndices: directLHSIndices,
