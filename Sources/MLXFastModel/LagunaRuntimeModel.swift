...
/// Telemetry re-roll nonce r9: unchanged candidate, official retry per the
/// established unchanged-resubmission practice (cf. e8e195b5's promoted nonce).
/// Attempts 212e97cf, 6a709649, 5367d9f7, 6a774a99, 64fe3ae1, and 94c2a42
/// all died on candidate-side telemetry (12/12 timed attempts: eleven n=4,
/// one n=5 killed by the plausibility-window artifact); every RESULT line
/// across all six runs computed to a promoting score (~1.85-1.86 vs
/// frontier 1.84352). The candidate's ~1.0s compute window sits below the
/// sampler's reliable-n=5 boundary; operator escalation is in flight.
